acmbtc – A fast, clean and small Actinium C library
=============================================================

What is acmbtc?
----------------

acmbtc is a very portable C library for creating and manipulating Actinium data structures and interacting with the p2p network.
...
##### Generate the P2PKH address from a hex encoded compact public key
    ...
    ./acmtool -command addrfrompub -pubkey 023d86ca58e2519cce1729b4d36dfe5a053ad5f4ae6f7ef9360bee4e657f7e41c9
    > p2pkh address: 1N5ZkjyabcZLLHMweJrSkn3qedsPGzAx9m


##### Generate new BIP32 master key

    ./acmtool -command hdgenmaster
...
##### Print HD node
    ...
    ./acmtool -command hdprintkey -privkey xprv9s21ZrQH143K3C5hLMq2Upsh8mf9Z1p5C4QuXJkiodSSihp324YnWpFfRjvP7gqocJKz4oakVwZn5cUgRYTHtNRvGqU5DU2Gn8MPM9jHvfC
...
##### Derive child key (second child key at level 1 in this case)
    ...
    ./acmtool -command hdderive -keypath m/1h -privkey xprv9s21ZrQH143K3C5hLMq2Upsh8mf9Z1p5C4QuXJkiodSSihp324YnWpFfRjvP7gqocJKz4oakVwZn5cUgRYTHtNRvGqU5DU2Gn8MPM9jHvfC
...
##### Send a raw transaction to random peers on testnet and show debug infos
    ...
    ./acm-send-tx -d -t <txhex>

##### Send a raw transaction to specific peers on mainnet and show debug infos use a timeout of 5s

    ./acm-send-tx -d -s 5 -i 192.168.1.110:14443,127.0.0.1:14443 <txhex>

The acm-spv CLI
--------------

This tool can be used to download & scan the Actinium blockchain.
